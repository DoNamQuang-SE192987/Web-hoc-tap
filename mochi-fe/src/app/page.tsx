                      ...
                      <div className="space-y-8 flex flex-col items-center py-6">
                        ...
                        {learningStep === 'dictation' && (
                          <div className="w-full space-y-6 text-center animate-fade-in pb-10">
                            ...
                            <form onSubmit={handleCheckDictation} className="max-w-md mx-auto w-full px-4 space-y-4">
                              <Input
                        ...
                        {learningStep === 'fillBlank' && (
                          <div className="w-full space-y-6 text-center animate-fade-in pb-10">
                            ...
                            <form onSubmit={handleCheckFillBlank} className="max-w-md mx-auto w-full px-4 space-y-4">
                              <Input
